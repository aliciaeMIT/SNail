...
class LevelSymmetricQuadrature:
    """
    Generates level-symmetric quadrature set
    ...
    def __init__(self):
        ...
        # Create a dictionary of values used to generate eta, xi, mu and
    ...
    def getQuadrature(self, order=4):
        ...
        quad = {}
        quad['order'] = order
        quad['n_polar'] = order // 2
        quad['n_angles'] = 2 * quad['n_polar'] * \
                             (2 * quad['n_polar'] + 2) // 8 * 4
        quad['n_angles_per_octant'] = quad['n_angles'] // 4

        quad['eta'] = numpy.zeros(quad['n_angles_per_octant'])
        quad['xi'] = numpy.zeros(quad['n_angles_per_octant'])
        quad['mu'] = numpy.zeros(quad['n_angles_per_octant'])
        quad['weight'] = numpy.zeros(quad['n_angles_per_octant'])
        ...
        for i in range(order // 2):
            for j in range(order // 2 - i):
                ...
                quad['eta'][m] = self.att[order][i]
                quad['xi'][m] = self.att[order][j]
                quad['mu'][m] = sqrt(1.0 - quad['eta'][m]**2 - quad['xi'][m]**2)
